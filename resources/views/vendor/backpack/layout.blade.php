...
<body class="hold-transition {{ config('backpack.base.skin') }} sidebar-mini">
	<script type="text/javascript">
		...
		(function () {
		    var sidebar_collape = "{{config('backpack.base.sidebar-collapse')}}";
            /*console.log('collapse'+sidebar_collape)*/
			if (Boolean(sessionStorage.getItem('sidebar-toggle-collapsed')) || Boolean(sidebar_collape)) {
